var onRun = function(context) {
    ...
    var buffer;
    if (identifier == "copy_as_png_1x") {
        buffer = sketch.export(layer, option);
        pasteboard.setImage(buffer.toNSData());
        sketch.UI.message("PNG @1x copied to clipboard");
    }
    ...
    if (identifier == "copy_as_png_2x") {
        ...
        buffer = sketch.export(layer, option);
        pasteboard.setImage(buffer.toNSData());
        sketch.UI.message("PNG @2x copied to clipboard");
    }

    if (identifier == "copy_as_png_3x") {
        option.scales = "3";
        buffer = sketch.export(layer, option);
        pasteboard.setImage(buffer.toNSData());
        sketch.UI.message("PNG @3x copied to clipboard");
    }
